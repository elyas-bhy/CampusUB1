...
En ce qui concerne le site du LaBRI, il n'y a qu'un seul flux RSS pour les actualités, et le reste des événements se trouve sur d'autres pages HTML. Il faudra donc parser ces pages HTML pour en extraire les données importantes.
