...
\begin{figure}[h!]
  ...
  \setlength\fboxsep{5pt}
  \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=0.5\textwidth]{resources/preferences_mod.png}}
\end{figure}
...
\begin{figure}[h!]
  ...
  \setlength\fboxsep{5pt}
  \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=0.4\textwidth]{resources/contacts_mod.png}}
\end{figure}
...
\begin{figure}[h!]
  ...
  \setlength\fboxsep{5pt}
  \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=0.65\textwidth]{resources/events_mod.png}}
\end{figure}
