...
\end{itemize}
La recherche de personnes dans l'annuaire se fera en fonction des établissements auquels l'utilisateur s'est abonné. On pourra donc choisir grâce à un filtre entre rechercher une personne dans l'annuaire propre à un ou plusieurs établissements, ou la rechercher dans tous les annuaires.
...
\chapter{Tests et Validation}
  ...
  \section{Test 02: Maintient du choix de l'établissement}
    \begin{enumerate}
  ...
  \section{Test 03: Evènements}
    \begin{enumerate}
    \item Une fois les abonnements configurés, sélectionner le menu des évènements dans le menu principal.
    \end{enumerate}

    \underline{Résultats attendus}:
    \begin{itemize}
    \item Si l'application est connectée à internet: Les évènements de tous les établissements auxquels l'application est abonnée sont affichés.
    \item Sinon: Les évènements ayant déja été téléchargées sont affichées.
    \end{itemize}

  \section{Test 04: Ajout d'un évènement au téléphone}
    \begin{enumerate}
    \item TODO
    \end{enumerate}

  \section{Test 05: Annuaire}
    \begin{enumerate}
    \item Une fois les abonnements configurés, sélectionner le menu de l'annuaire dans le menu principal.
    \end{enumerate}
  ...
  \section{Test 06: Filtrer l'Annuaire}
    \begin{enumerate}
    \item Accéder à l'annuaire à partir du menu principal.
    \item Ecrire dans la barre de recherche.
    \end{enumerate}

    \underline{Résultat attendu}: Le nombre de résultat se réduit à ceux qui correspondent à ce qui est écrit dans la barre de recherche.
