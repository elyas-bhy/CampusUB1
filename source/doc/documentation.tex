...
\renewcommand{\labelitemi}{$\bullet$}
\item Priorité: 5/5.
\item Difficultés techniques: mise à jour des URLs si les adresses des établissements sont modifiées.
...
\renewcommand{\labelitemi}{$\bullet$}
\item Priorité: x/5.
\item Difficultés techniques: TODO
...
% Quantification, risques (alternatives/parades), faisabilité.
% Tests systeme, tests de validation de quantification, tests de validation des proprietes
